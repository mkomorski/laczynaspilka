...
__decorate([
    ...
    __metadata("design:type", String)
], Subscriber.prototype, "matchId", void 0);
__decorate([
...
exports.Subscriber = Subscriber = __decorate([
    ...
    (0, typeorm_1.Index)(['matchId', 'email'], { unique: true, where: '"email" IS NOT NULL' }),
    (0, typeorm_1.Index)(['matchId', 'phone'], { unique: true, where: '"phone" IS NOT NULL' })
], Subscriber);
